...
/***/ (function(module, exports) {
	...
	var ArtifactoryDao = exports.ArtifactoryDao = (function () {
	    ...
	    function ArtifactoryDao($resource, RESOURCE, artifactoryNotificationsInterceptor) {
	...
	function ArtifactoryDaoFactory($resource, RESOURCE, artifactoryNotificationsInterceptor) {
	    return function () {
...
/***/ (function(module, exports) {
	...
	function TreeNodeFactory($q, $injector, RESOURCE, ArtifactoryHttpClient, ArtifactWatchesDao, ArtifactActionsDao, NativeBrowser) {
	...
	var TreeNode = (function () {
	    function TreeNode(data, $q, $injector, RESOURCE, ArtifactoryHttpClient, ArtifactWatchesDao, ArtifactActionsDao, NativeBrowser) {
	            ...
	            value: function getDownloadPath() {
	                ...
	                if (!this.downloadPathPromise) {
	                    ...
	                    this.downloadPathPromise = this.artifactActionsDao.perform({ action: "download" }, data).$promise.then(function (response) {
	                        return _this.actualDownloadPath = response.data.path;
	                    });
	                }
