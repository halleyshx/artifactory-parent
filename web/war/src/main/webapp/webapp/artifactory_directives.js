...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jfAccordion = __webpack_require__(86).jfAccordion;

	var jfFooter = __webpack_require__(87).jfFooter;

	var jfHeader = __webpack_require__(88).jfHeader;

	var jfMessages = __webpack_require__(91).jfMessages;

	var jfHeaderSearch = __webpack_require__(92).jfHeaderSearch;

	var jfBrowseFiles = __webpack_require__(93).jfBrowseFiles;

	var jfSwitchToggle = __webpack_require__(94).jfSwitchToggle;

	var dynamicDirective = _interopRequire(__webpack_require__(95));

	var jfMultiDeploy = __webpack_require__(96).jfMultiDeploy;

	var jfSingleDeploy = __webpack_require__(98).jfSingleDeploy;

	var jfPrint = __webpack_require__(99).jfPrint;

	var jfAutoFocus = __webpack_require__(100).jfAutoFocus;

	var jfBodyClass = __webpack_require__(101).jfBodyClass;

	var jfInputTextV2 = __webpack_require__(102).jfInputTextV2;

	var jfCronFormatter = __webpack_require__(103).jfCronFormatter;

	var jfBreadcrumb = __webpack_require__(104).jfBreadcrumb;

	var jfSpinner = __webpack_require__(105).jfSpinner;

	var jfDisableFeature = __webpack_require__(106).jfDisableFeature;

	var jfHideForAol = __webpack_require__(107).jfHideForAol;

	var jfFileDrop = __webpack_require__(108).jfFileDrop;

	var jfAutoComplete = __webpack_require__(109).jfAutoComplete;

	var jfDockerV2Layer = __webpack_require__(110).jfDockerV2Layer;

	var jfDockerV2Layers = __webpack_require__(112).jfDockerV2Layers;

	var rtfactStorageViewer = __webpack_require__(114).rtfactStorageViewer;

	var rtfactStorageElement = __webpack_require__(116).rtfactStorageElement;

	var rtfactStorageUsage = __webpack_require__(118).rtfactStorageUsage;

	var jfValidatorName = __webpack_require__(119).jfValidatorName;

	var jfValidatorNamePrefixNotNumeric = __webpack_require__(120).jfValidatorNamePrefixNotNumeric;

	var jfValidatorUniqueId = __webpack_require__(121).jfValidatorUniqueId;

	var jfValidatorXmlName = __webpack_require__(122).jfValidatorXmlName;

	var jfValidatorCron = __webpack_require__(123).jfValidatorCron;

	var jfValidatorLdapUrl = __webpack_require__(124).jfValidatorLdapUrl;

	var jfValidatorPathPattern = __webpack_require__(125).jfValidatorPathPattern;

	var jfValidatorIntValue = __webpack_require__(126).jfValidatorIntValue;

	var jfValidatorMaxTextLength = __webpack_require__(127).jfValidatorMaxTextLength;

	var jfSpecialChars = __webpack_require__(128).jfSpecialChars;

	var jfRepokeyValidator = __webpack_require__(129).jfRepokeyValidator;

	var jfValidatorDateFormat = __webpack_require__(131).jfValidatorDateFormat;

	var jfValidatorReverseProxyPort = __webpack_require__(132).jfValidatorReverseProxyPort;

	var jfRadioButton = __webpack_require__(133).jfRadioButton;

	var jfListSelection = __webpack_require__(134).jfListSelection;

	var jfManageProLicense = __webpack_require__(135).jfManageProLicense;

	var jfManageHaLicenses = __webpack_require__(136).jfManageHaLicenses;

	var jfDragAndDropTxt = __webpack_require__(137).jfDragAndDropTxt;

	var jfNews = __webpack_require__(138).jfNews;
...
/***/ (function(module, exports) {
	...
	var events = {
	    ...
	    TREE_REFRESH_FAVORITE_STATE: "tree:refresh:favorite:state",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HELP = _interopRequire(__webpack_require__(90));

	var jfHeaderController = (function () {
	    function jfHeaderController($scope, $q, User, $state, $timeout, $window, GeneralConfigDao, FooterDao, JFrogEventBus, ArtifactoryFeatures, $rootScope, $location, $http, ArtifactoryState, ArtifactoryHttpClient, OnBoardingWizard, GoogleAnalytics) {
	        var _this = this;
	        ...
	        _getFooterData: {
	            value: function _getFooterData(force) {
	                ...
	                this.footerDao.get(force).then(function (footerData) {
	                    ...
	                    } else if (footerData.logoUrl) _this.logoUrl = footerData.logoUrl;else _this.logoUrl = _this.defaultLogoUrl;
	        ...
	        login: {
	            value: function login() {
	                ...
	                if (this.samlRedirectEnabled) {
	                    this.ArtifactoryHttpClient.post("/auth/loginRelatedData", null, {}).then(function (res) {
	                        if (res.data.ssoProviderLink) {
	                            _this.$window.open(res.data.ssoProviderLink, "_self");
	                        } else {
	            ...
	            value: function initQuickActions(actionsController) {
	                ...
	                actionsController.setActions([{
	                    ...
	                    action: function () {
	                        ...
	                        _this.$state.go("admin.repositories.list.new", { repoType: "distribution" });
	                    }
	                }, {
	                    name: "createUser",
	                    action: function () {
	        ...
	        onClickUserHeaderSection: {
	            value: function onClickUserHeaderSection(e) {
	                if (!this.isQuickActionsAvailable()) {
	                    return;
	                }if ($(e.target).hasClass("icon-more") || $(e.target).hasClass("actions-more")) {
	                    return;
	    ...
	    _createClass(jfMessagesController, {
	        ...
	        getConstantMessages: {
	            value: function getConstantMessages() {
	                ...
	                for (var i in msgs) {
	                    var msgObj = msgs[i];
	                    if (msgObj.message.indexOf("<DISMISSIBLE>") > 0) {

	                        var dismissCodeRegex = /(?:<MSGID:(.*)>)/g;
	                        msgObj.dismissCode = dismissCodeRegex.exec(msgObj.message)[1];
	                        msgObj.message = msgObj.message.replace(dismissCodeRegex, "");
	                        msgObj.message = msgObj.message.replace("<DISMISSIBLE>", "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jfSingleDeployController = (function () {
	    ...
	    _createClass(jfSingleDeployController, {
	        ...
	        onAfterAddingFile: {
	            value: function onAfterAddingFile(fileItem) {
	                this.isBundle = _.endsWith(fileItem.file.name, "zip") || _.endsWith(fileItem.file.name, "tar") || _.endsWith(fileItem.file.name, "tgz") || _.endsWith(fileItem.file.name, "tar.gz");
...
/***/ (function(module, exports) {
	...
	var jfBodyClassController = (function () {
	    function jfBodyClassController($element, $state, $scope) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.jfDockerV2Layer = jfDockerV2Layer;
	Object.defineProperty(exports, "__esModule", {
	    value: true
	});
	/*
	...
	var COLOR_MAP = _interopRequire(__webpack_require__(111));

	var jfDockerV2LayerController = (function () {
	    function jfDockerV2LayerController() {
	        _classCallCheck(this, jfDockerV2LayerController);
	        ...
	        var created = this.data.created.split("T");
	        this.created = created[0] + " " + created[1].split(".")[0];

	        if (this.preselected) this.setSelected(true);
	    }

	    _createClass(jfDockerV2LayerController, {
	        isSelected: {
	    ...
	    return jfDockerV2LayerController;
	})();

	function jfDockerV2Layer() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.jfDockerV2Layers = jfDockerV2Layers;
	Object.defineProperty(exports, "__esModule", {
	    value: true
	});

	var KEY_DICTIONARY = _interopRequire(__webpack_require__(113));

	var jfDockerV2LayersController = (function () {
	    function jfDockerV2LayersController($scope, $attrs) {
	        _classCallCheck(this, jfDockerV2LayersController);
	    ...
	    _createClass(jfDockerV2LayersController, {
	        setSelected: {
	            value: function setSelected(layer) {
	                if (this.selectedLayer && this.selectedLayer !== layer) this.selectedLayer.setSelected(false);
	                this.selectedLayer = layer;
	            }
	        },
	        refreshView: {
	            value: function refreshView() {
	                if (this.layerDirectives.length) this.layerDirectives[0].setSelected(true);
	    ...
	    return jfDockerV2LayersController;
	})();

	function jfDockerV2Layers() {
	    return {
	        restrict: "E",
	        scope: {
	            controller: "=",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SpecialValues = _interopRequire(__webpack_require__(115));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var STORAGE_TYPES_DICTIONARY = _interopRequire(__webpack_require__(117));
	    ...
	    _createClass(rtfactStorageElementController, {
	        ...
	        getUsageString: {
	            value: function getUsageString() {
	                ...
	                if (this.element.data.usageSpace === SpecialValues.UNSUPPORTED_VALUE) {
	                    return null;
	                } else {
	                    var usageString = (this.element.data.usageSpace !== "0" ? this.fileSizeFilter(this.element.data.usageSpace) + " / " : includePercentage ? "0 / " : "Empty - ") + (!SpecialValues.isSpecialValue(this.element.data.totalSpace) ? this.fileSizeFilter(this.element.data.totalSpace) : this.element.data.totalSpace === SpecialValues.INFINITY_VALUE ? "∞" : "?");

	                    if (includePercentage) {
	                        usageString += !SpecialValues.isSpecialValue(this.element.data.totalSpace) ? " (" + (100 * this.element.data.usageSpace / this.element.data.totalSpace).toFixed(1) + "%)" : "";
	                    }
	                    return usageString;
	                }
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fieldsValuesDictionary = _interopRequire(__webpack_require__(130));
...
/***/ (function(module, exports) {
	...
	var jfRadioButtonController = function jfRadioButtonController($element, $transclude, $timeout) {
...
/***/ (function(module, exports) {
	...
	var jfListSelectionController = (function () {
	    function jfListSelectionController($timeout, $filter) {
	        var _this = this;
	        ...
	        this.$timeout = $timeout;
	        this.$timeout(function () {
	            var containerHeight = $(".group-list-wrapper").innerHeight();
	            var itemHeight = $(".group-list-item").outerHeight();
	    ...
	    _createClass(PaginationApi, {
	        ...
	        getCurrentPage: {
	            value: function getCurrentPage() {
	                if (this.ctrl.currentPage > this.getTotalPages()) this.ctrl.currentPage = this.getTotalPages();
	                if (this.ctrl.currentPage < 1) this.ctrl.currentPage = 1;
	                return this.ctrl.currentPage;
	            }
	        },
	        nextPage: {
	            value: function nextPage() {
	                if (this.ctrl.currentPage < this.getTotalPages()) this.ctrl.currentPage++;
	            }
	        },
	        prevPage: {
	            value: function prevPage() {
	                if (this.ctrl.currentPage > 1) this.ctrl.currentPage--;
	            }
	        },
	        setPage: {
	            value: function setPage(pageNum) {
	                if (pageNum >= 1 && pageNum <= this.getTotalPages()) this.ctrl.currentPage = pageNum;
	            }
	        },
	        update: {
	            value: function update() {
	                ...
	                this.ctrl.$timeout(function () {
	                    ...
	                    if (_this.listener) _this.listener(_this.getCurrentPage());
	                });
	            }
	        },
...
/***/ (function(module, exports) {
	...
	var jfManageHaLicensesController = (function () {
	    function jfManageHaLicensesController($timeout, $state, $rootScope, $scope, $window, JFrogModal, User, HaLicensesDao, JFrogGridFactory, uiGridConstants, JFrogNotifications, SaveArtifactoryHaLicenses, ArtifactoryState) {
