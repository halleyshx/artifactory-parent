...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Models = _interopRequire(__webpack_require__(142));

	var ValidationConstants = _interopRequire(__webpack_require__(144));

	var EVENTS = _interopRequire(__webpack_require__(48));

	if (angular.version.full !== "1.5.11") console.log("%cWrong AngularJS version!", "color: #ff0000;");
	 ...
	 */
	function appConfig($stateProvider, $urlRouterProvider, ngClipProvider, $httpProvider, JFrogUILibConfigProvider) {
	...
	angular.module("artifactory.ui", ["jfrog.ui.essentials", "color.picker", "ui.layout", "ngMockE2E", "selectize", "angular-capitalize-filter", "monospaced.mousewheel",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AdminMenuItems = __webpack_require__(143).AdminMenuItems;
