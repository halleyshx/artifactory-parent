...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ApiConstants = _interopRequire(__webpack_require__(89));

	var ArtifactoryCookies = __webpack_require__(145).ArtifactoryCookies;

	var ArtifactoryHttpClient = __webpack_require__(146).ArtifactoryHttpClient;

	var ArtifactoryStorage = __webpack_require__(147).ArtifactoryStorage;

	var ArtifactoryXmlParser = __webpack_require__(148).ArtifactoryXmlParser;
	...
	var AdvancedStringMatch = __webpack_require__(169).AdvancedStringMatch;

	var ArtifactorySidebarDriver = __webpack_require__(170).ArtifactorySidebarDriver;

	var OnBoardingWizard = __webpack_require__(171).OnBoardingWizard;

	var SaveArtifactoryHaLicenses = __webpack_require__(172).SaveArtifactoryHaLicenses;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RC = _interopRequire(__webpack_require__(89));
	...
	var User = (function () {
	    ...
	    _createClass(User, {
	        ...
	        canViewBuildState: {
	            ...
	            value: function canViewBuildState(state, stateParams, isChangeTab) {
	        ...
	        getLoginData: {
	            value: function getLoginData() {
	                return this.http.post(this.RESOURCE.AUTH_LOGIN_DATA).then(function (response) {
	        ...
	        getOAuthLoginData: {
	            value: function getOAuthLoginData() {
	                return this.http.get(this.RESOURCE.OAUTH_LOGIN).then(function (response) {
...
/***/ (function(module, exports) {
	...
	function artifactorySessionInterceptor($injector) {
	    ...
	    function checkAuthorization(res) {
	        if (res.status === 401) {
	            ArtifactoryHttpClient.post("/auth/loginRelatedData", null, {}).then(function (res) {
...
/***/ (function(module, exports) {
	...
	var ArtifactoryFeatures = exports.ArtifactoryFeatures = (function () {
	    function ArtifactoryFeatures(FooterDao, ArtifactoryState, $location, GoogleAnalytics) {
	        var _this = this;
	        ...
	        isHidden: {
	            value: function isHidden(feature) {
	                ...
	                if (feature === "httpsso" && this.isAol() && this.footerDao.getInfo().httpSsoEnabledAOL) {
	                    return;
	                }return this.isAol() && _.contains(HIDDEN_AOL_FEATURES, feature) && !(this.isDedicatedAol() && _.contains(SHOW_ON_DEDICATED_AOL, feature)) || this.isOss() && _.contains(HIDDEN_OSS_FEATURES, feature);
	            }
	        },
	        isVisible: {
	                ...
	                if (this.allowGA) {
	                    ...
	                    this.ArtifactoryState.setState("gaTrackPage", function () {
	                        ...
	                        if (url.match(/\/browse\/tree\/|browse\/simple/)) {
	                            ...
	                            _this._sendPageView(url.match(/#.*(tree|simple)\/.*?\//)[0]);
	                        } else if (url.match(/(#.+)/)) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var API = _interopRequire(__webpack_require__(89));
	...
	var ArtifactActions = exports.ArtifactActions = (function () {
	    function ArtifactActions(JFrogEventBus, ArtifactActionsDao, StashResultsDao, $state, $window, $rootScope, $timeout, JFrogNotifications, FooterDao, $sce, JFrogModal, selectTargetPath, selectDeleteVersions, PushToBintrayModal, DistributionDao, $q, JFrogIFrameDownload, NativeBrowser, User, GoogleAnalytics) {
	    ...
	    _createClass(ArtifactActions, {
	        perform: {
	            value: function perform(actionObj, node, context) {
	                var actionData = {
	                    actionTitle: ACTIONS[actionObj.name].title,
	        ...
	        _doDownloadFolder: {
	            value: function _doDownloadFolder(node) {
	                ...
	                this.artifactActionsDao.performGet({
	                    ...
	                    modalScope.showBlockedFiles = false;
	                    ...
	                    modalScope.xrayBlockedPaths = data.data.xrayBlockedPaths;
	                    modalScope.toggleBlockedList = function () {
	                        modalScope.term = "";
	                        modalScope.showBlockedFiles = !modalScope.showBlockedFiles;
	                    };
	        ...
	        _doIgnoreAlert: {
	            value: function _doIgnoreAlert(node) {
	                var _this = this;

	                this._performActionInServer("ignoreAlert", node, {}, { param: "true" }).then(function (response) {
	                    _this.JFrogEventBus.dispatch(EVENTS.ACTION_IGNORE_ALERT, node);
	                });
	            }
	        },
	        _doUnignoreAlert: {
	            value: function _doUnignoreAlert(node) {
	                var _this = this;

	                this._performActionInServer("ignoreAlert", node, {}, { param: "false" }).then(function (response) {
	                    _this.JFrogEventBus.dispatch(EVENTS.ACTION_UNIGNORE_ALERT, node);
	                });
	            }
	        },
	        _doNativeBrowser: {
	        ...
	        _doFavorites: {
	            value: function _doFavorites(node) {
	                ...
	                if (!localStorage.favoritesRepos) {
	                    ...
	                    this.JFrogEventBus.dispatch(EVENTS.TREE_REFRESH_FAVORITE_STATE, node.data);
	                }
	            }
	        },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FIELD_OPTIONS = _interopRequire(__webpack_require__(130));
	        ...
	        _initSetMeUpScope: {
	            value: function _initSetMeUpScope() {
	                ...
	                this.setMeUpScope.resolveSnippet = function () {
	                    ...
	                    if (_this.setMeUpScope.selection.repoType.value === "docker" && resolveDockerReverseProxy && !_this.artifactoryFeatures.isAol() && !_this.artifactoryFeatures.isOss() && _this.user.name !== "anonymous") {
...
/***/ (function(module, exports) {
	...
	var snippets = {
	    ...
	    helm: {
	        ...
	        general: [{
	            before: "To work with Helm repositories, first install and configure your client<br/>according to the guidelines described in the <a target=\"blank\" href=\"https://www.jfrog.com/confluence/display/RTF/Helm+Chart+Repositories#HelmChartRepositories-ConfiguringYourHelmClient\">Artifactory User Guide</a>.<br/>Set your default Artifactory Helm repository/registry with the following command:",
	        ...
	        read: {
	            ...
	            snippet: "helm install $1/[chartName]"
	        },
	        deploy: {
	    ...
	    nuget: {
	        general: [{
	            ...
	            before: "<b>NuGet Client Configuration</b><br/>To configure NuGet client to work with Artifactory you will need to add Artifactory to the list of sources. To add this repository use the following command",
	        ...
	        read: [{
	            before: "<b>NuGet Client Resolve</b><br/> using the NuGet client, run the following command",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TOOLTIP = _interopRequire(__webpack_require__(97));
...
/***/ (function(module, exports) {
	...
	exports.AdvancedStringMatch = AdvancedStringMatch;
	Object.defineProperty(exports, "__esModule", {
	    value: true
	});
	function getMatchCount(str, match) {
	...
	function doMatch(str, match) {
	    ...
	    if (index !== -1) {
	        ...
	        for (var i = 0; i < parts.length; i++) {
	            var matchCount = getMatchCount(parts[i], match, !gotMatch || searchInside);
	...
	function doHighlight(elem, segments) {
	    ...
	    if (textNode) {
	        var highlighted = getHighlighted(textNode.nodeValue, segments, hlElemType, hlClass);
	...
	function AdvancedStringMatch() {
	    return {
	        match: function (str, match) {
	            return doMatch(str, match);
	        },
	        highlight: function (elem, segments, hlElemType, hlClass) {
	            return doHighlight(elem, segments, hlElemType, hlClass);
	        }
	    };
	}
...
/***/ (function(module, exports) {
	...
	var ArtifactorySidebarDriver = exports.ArtifactorySidebarDriver = (function () {
	    function ArtifactorySidebarDriver($timeout, $rootScope, $state, User, FooterDao, ArtifactoryFeatures, JFrogEventBus, ArtifactoryStorage, ArtifactoryState) {
	                ...
	                this.footerDao.get(false).then(function (footerData) {
	                    ...
	                    adminItems.forEach(function (item) {
	                        ...
	                        item.subItems.forEach(function (subitem) {
	                            ...
	                            if (subitem.label === "JFrog Xray") {
	                                if (_this.isAol && !_this.isDedicatedAol) {
	                                    ...
	                                    if (!xrayDetails.isXrayLicensed) {
	                                        ...
	                                        if (xrayDetails.licenseType != "ENT" || _this.isAol && _this.isDedicatedAol) {
	                                            subitem.isDisabled = true;
	                                        }
	                                    } else {
	                                        subitem.isDisabled = false;
	                                    ...
	                                    if (!_this.user.canView(subitem.state)) subitem.isDisabled = true;
	                                }
	                            }
	                        });
	                    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fieldOptions = _interopRequire(__webpack_require__(130));
	        ...
	        show: {
	            value: function show() {
	                ...
	                whenReady.then(function () {
	                    ...
	                    if (!quickSetup && !_this.initStatus.hasLicenseAlready && !_this.features.isAol() && !_this.features.isOss()) steps.push({
	                        ...
	                        description: "Don't have a license? Start a " + "<a href=\"https://www.jfrog.com/artifactory/free-trial/\" target=\"_blank\" class=\"nowrap\">" + "free trial <i class=\"icon icon-external-link\"></i>" + "</a>",
	                        skippable: false,
	                    ...
	                    steps.push({
	                        ...
	                        description: "Congrats! These are the default repositories we created for you.<br>" + "You’re now ready to speed up your software releases!<br>" + "Want to configure your client(s) and get started? Click the " + "<a href=\"https://www.jfrog.com/confluence/display/RTF/Using+Artifactory#UsingArtifactory-SetMeUp\" target=\"_blank\">" + "Set Me Up <i class=\"icon icon-external-link\"></i>" + "</a> button for each repository.<br>" + "Want to learn more about different repository types? Consult the " + "<a href=\"https://www.jfrog.com/confluence/display/RTF\" target=\"_blank\" class=\"nowrap\">" + "JFrog Artifactory User Guide <i class=\"icon icon-external-link\"></i>" + "</a>.",
	                    ...
	                    if (quickSetup) {
	                        ...
	                        step.name = "All Done!";
	                        step.description = "These are the default repositories we created for you.<br>" + "Want to configure your client(s) and get started? Click the <a href=\"https://www.jfrog.com/confluence/display/RTF/Using+Artifactory#UsingArtifactory-SetMeUp\" target=\"_blank\">Set Me Up</a> button for each repository.";
	                    }
	            ...
	            value: function isSystemOnboarding() {
	                ...
	                if (prevOnboarding === undefined) {
	                    ...
	                    this.OnboardingDao.initStatus({ $no_spinner: true }).$promise.then(function (status) {
	                        ...
	                        _this.ArtifactoryState.setState("initStatus", status);
	                        var onboarding = !_this.initStatus.hasRepos && !_this.initStatus.skipWizard && !localStorage.skipOnboarding;
	    ...
	    _createClass(WizardController, {
	            ...
	            value: function initPackageTypesStep() {
	                ...
	                if (!this.gotPackageTypes) {
	                    this.OnboardingDao.reposStates().$promise.then(function (response) {
	                        _this.packageTypes.packageTypes = _.cloneDeep(fieldOptions.repoPackageTypes);
	                        _this.packageTypes.packageTypes = _.map(_this.packageTypes.packageTypes, function (type) {
	                            ...
	                            var addTextBelowIcon = ["Bower", "Chef", "CocoaPods", "Conan", "Pypi", "Puppet", "Opkg", "Composer", "SBT", "Gradle", "Gems", "NuGet", "GitLfs", "Generic"];
	                        ...
	                        _this.packageTypes.packageTypes = _.sortBy(_this.packageTypes.packageTypes, function (type) {
	                            return type.text.toLowerCase();
	                        });
	                        _this.packageTypes.packageTypes = _.sortBy(_this.packageTypes.packageTypes, function (type) {
	                            return !type.unavailable && !type.disabled ? 0 : type.disabled ? 1 : 2;
	                        });

	                        // Change PHP Composer -> Composer
	                        _.find(_this.packageTypes.packageTypes, function (type) {
	                ...
	                this.packageTypes.checkNoResults = function (typeFilter) {
	                    if (typeFilter && typeFilter.length > 0 && _.filter(_this.packageTypes.packageTypes, function (type) {
	                ...
	                this.packageTypes.selectRepoType = function (type) {
	                    ...
	                    _this.packageTypes.selectedTypes = _.filter(_this.packageTypes.packageTypes, function (type) {
	        ...
	        getIconForPackageType: {
	            value: function getIconForPackageType(type) {
	                var packageData = _.find(this.packageTypes.packageTypes, { value: type });
